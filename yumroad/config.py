...
class BaseConfig:
    ...
    STRIPE_SECRET_KEY = os.environ['STRIPE_SECRET_KEY'] #os.getenv('STRIPE_SECRET_KEY', 'sk_test_k1')
    STRIPE_PUBLISHABLE_KEY = os.environ['STRIPE_PUBLISHABLE_KEY'] #os.getenv('STRIPE_PUBLISHABLE_KEY', 'sk_test_k1')
